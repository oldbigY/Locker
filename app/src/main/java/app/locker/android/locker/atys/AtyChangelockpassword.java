 ...
 */
public class AtyChangelockpassword extends Activity {

    //定义各个控件
    public EditText etOldPassword,etNewPassword,etPasswordAgain;
    public Button btnOldPassword,btnNewPassword,btnCancel,btnTitleCantel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aty_change_lock_password);
        ...
        btnTitleCantel= (Button) findViewById(R.id.btnTitleCancel);
        ...
        tvTitle.setText(R.string.changelockerpassword);
        ...
        btnOldPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(etOldPassword.getText())) {
                    Toast.makeText(AtyChangelockpassword.this,R.string.complete_the_information,Toast.LENGTH_SHORT).show();
                    return;
                }

                //设置传输参数
                StringBuffer parmasStr=new StringBuffer();
                parmasStr.append(Config.KEY_ACTION).append("=").append(Config.ACTION_CONFIRM_OLD_LOCKER_PASSWORD).append("&")
                ...
                new ChangePassword(parmasStr.toString(), new ChangePassword.SuccessCallback() {
                    ...
                    @Override
                    public void onFail() {
                        Toast.makeText(AtyChangelockpassword.this,R.string.password_is_wrong,Toast.LENGTH_SHORT).show();
                        return;
                    }
                });
        ...
        btnNewPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!etNewPassword.getText().toString().trim().equals(etPasswordAgain.getText().toString().trim())){
                    Toast.makeText(AtyChangelockpassword.this,R.string.password_not_the_same,Toast.LENGTH_SHORT).show();
                    return;
                }

                //设置传输参数
                StringBuffer parmasStr=new StringBuffer();
                parmasStr.append(Config.KEY_ACTION).append("=").append(Config.ACTION_CHANGE_LOCKER_PASSWORD).append("&")
                        .append(Config.KEY_USER_NAME).append("=").append(user_name).append("&")
                ...
                new ChangePassword(parmasStr.toString(), new ChangePassword.SuccessCallback() {
                    @Override
                    public void onSuccess() {
                        Toast.makeText(AtyChangelockpassword.this,R.string.success_change_password,Toast.LENGTH_SHORT).show();
                        finish();
                    }
                }, new ChangePassword.FailCallback() {
                    @Override
                    public void onFail() {
                        Toast.makeText(AtyChangelockpassword.this,R.string.fail_change_password,Toast.LENGTH_SHORT).show();
                        return;
                    }
                });
            }
        ...
        btnTitleCantel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
